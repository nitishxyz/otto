...
const InputComponent = forwardRef<TextInput, InputProps>(({
  ...
  // For multiline inputs, use dynamic height
  const containerStyle = multiline
    ? [styles.container, { height: "auto" as const, minHeight: minHeight || 100 }]
    : styles.container;

  const inputStyle = multiline
    ? [styles.base, { textAlignVertical: "top" as const, paddingTop: 12, paddingBottom: 12 }, style]
    : [styles.base, style];
